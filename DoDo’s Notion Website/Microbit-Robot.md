***The assignment:***
"Create a basic car that can pick up something and move by wheels using a microbit controller and SG90 micro servos from scratch also document your project".

1) Instead of creating a basic robot i wanted to be better and brainstormed for an idea that would be better than average. Then I decided on making the robot animal (Monkey) shaped. 
2) I opened onshape, logged in and started a new sketch.
3) I noted down the dimensions of the Micro Servo SG90 on a paper as you can see below.

![ServoDimensions](Microbit%20Robot%20Project/ServoDimensions.jpg)


4) I sketched and then extruded the design to make it 3D.
...
10) I was going to scale the caster wheel but saw that it wasn't needed so i straight up printed it.
11) I stuck the caster wheel and my robot together and my robot was standing upright at last.
...
14) I coded by using blocks since I didn't have time to learn another coding language.
...
H.M.: I noticed that the crocodile cables were disconnecting when the robot moved and researched how I could make them not disconnect so my robot wouldn't stop working
I found out that using a male to crocodile cable was far more effective and that way the wiring wouldn't keep disconnecting, sadly we didn't have those in our
computer lab. Nonetheless even though I wouldn't be able to make it I learnt how to make it better.


**How To Connect a Microbit Controller To a Computer and Code It:**
1. Open https://makecode.microbit.org and log in.
2. Start new project.
3. Connect ur microbit controller to your computer by its cable.
4. Click the three dots right next to the download button on the left bottom of the screen and follow instructions.
5. You can write your code by blocks or using a coding language.
...
**How To Connect a Microbit Controller To a Micro Servo Motor (SG90):**
1. Get 3 male to male jumper cables for each motor.
...
6. How to print a 3D design better.
...
4. Make sure to decrease filling while printing to save up on plastic usage.
5. If you're using glue make sure to get as little as you can on the servos.
6. Make sure the cables are color coded so things wouldn't get confusing while connecting them.
